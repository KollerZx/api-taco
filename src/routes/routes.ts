...
router.post('/v1/interface/foods', ( req, res ) => FoodController.render(req,res))

router.get('/v1/interface/category', (req,res) => res.send("Lista as categorias de alimentos"))

router.get('/v1/interface/category/:categoryId', (req,res) => res.send("Lista os alimentos da categoria selecionada"))
